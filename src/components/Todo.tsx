...
export const Todo = () => {
  return (
    ...
    >
      ...
      <p className="text-lavender text-xl font-bold">First todo</p>
      <Link href="/edit" className="absolute bottom-0 left-0 cursor-pointer"><FiEdit3 color="#A483C2" size={24} /></Link>
    </div>
  )
}